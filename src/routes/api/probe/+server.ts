 ...
 * chaque appel. Aléatoire ⇒ incompressible, donc le débit mesuré reste un vrai débit.
 */
...
export const GET: RequestHandler = ({ url }) => {
	...
	// `access-control-allow-origin: *` évite que des sites tiers s'en servent comme
	// cible de test de débit (abus de bande passante).
